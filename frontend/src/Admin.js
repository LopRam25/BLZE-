  ...
  const saveReceipt = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Open the mobile-friendly receipt in a new tab for easy saving/sharing
        if (savedOrder && savedOrder.orderId) {
          window.open(`${BACKEND_URL}/receipt/${savedOrder.orderId}`, '_blank');
        }
        onClose();
      } else {
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        <span className="text-sm text-gray-900">Stock: {product.quantity}g</span>
