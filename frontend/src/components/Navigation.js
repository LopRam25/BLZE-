    ...
    <nav className="bg-black shadow-lg sticky top-0 z-50 border-b border-gray-800">
      ...
      <div className="fixed bottom-6 left-6 z-50">
        ...
        >
          ...
          <div className="absolute left-full ml-4 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
